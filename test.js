...
const commands = [
  ...
  {cmd: './node_modules/.bin/vue', args: ['init', '.', 'sandbox'], yes: true},
  {cmd: 'npm', args: ['install'], cwd: 'sandbox'},
  {cmd: 'npm', args: ['run', 'lint'], cwd: 'sandbox'},
  {cmd: 'npm', args: ['run', 'build'], cwd: 'sandbox'},
